...
// Trap Codes
#define EXCEPT_INT 0
#define EXCEPT_IBUS 1
#define EXCEPT_ADDRESS_LOAD_ERROR 4
#define EXCEPT_ADDRESS_STORE_ERROR 5
#define EXCEPT_SYSCALL 8
#define EXCEPT_BREAKPOINT 9
#define EXCEPT_RESERVED_INSTRUCTION 10
#define EXCEPT_OVERFLOW 12
#define EXCEPT_TRAP 13
